...
| | Feature is expected to display the admin dashboard when accessed through a super user | Tested the feature by adding /admin to the URL while loggedin as a super user | The feature behaved as expected. I got redirected to the admin dashboard page | Test concluded and passed | ![screenshot](documentation/features/feature17.png) |
